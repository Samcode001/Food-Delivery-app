...
const Card = (props) => {
  ...
  let priceOptions = Object.keys(options); //inbuilt function of javascript which retrieve all the elements of  objects when use with map function
        ...
        <div className="card mt-3" style={{ "width": " 18rem", "maxHeight": "360px" }}>
          ...
          <div className="card-body">
            ...
            <div className="container w-100">
              <select className='m-2 h-100 bg-success rounded' onChange={(e) => setQty(e.target.value)}> {/* in here we are intializing the state of qty by getting the value from user selects from options */}
